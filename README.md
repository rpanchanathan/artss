...
It cycles through 358 paintings, each shown large with a short note on what was going on when
...
- `artworks.json` — 358 entries. Images are hotlinked from six museums' open-access
