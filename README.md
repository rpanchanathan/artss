...
It cycles through 300 paintings, each shown large with a short note on what was going on when
...
- `artworks.json` — 300 entries. Images are hotlinked from six museums' open-access
