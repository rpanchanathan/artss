...
It cycles through 595 paintings, each shown large with a short note on what was going on when
...
- `artworks.json` — 595 entries. Images are hotlinked from six museums' open-access
